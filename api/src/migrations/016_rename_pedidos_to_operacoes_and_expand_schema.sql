-- 1) Renomeia pedidos -> operacoes (quando aplicável)
DO $$
BEGIN
  IF to_regclass('public.operacoes') IS NULL AND to_regclass('public.pedidos') IS NOT NULL THEN
    ALTER TABLE pedidos RENAME TO operacoes;
  END IF;
END $$;

-- 2) Garante tabela operacoes com estrutura alvo
...
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS caixa TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS email TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS frete NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS troco NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS origem TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS status INTEGER NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS cliente TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS endereco TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS parcelas JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS subtotal NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS telefone TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS valor_pago NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS acrescimos NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS observacao TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS quantidade INTEGER NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS valor_total NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS data_emissao TIMESTAMPTZ NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS tabela_preco TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS vendedor_nome TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS desconto_itens NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS operacao_itens JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS numero_operacao BIGINT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS outras_despesas NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS total_descontos NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS total_acrescimos NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS origem_plataforma JSONB NOT NULL DEFAULT '{}'::jsonb;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS desconto_adicional NUMERIC(14,2) NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS motivo_cancelamento TEXT NULL;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS modelo_numero_fiscais JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS movimentacoes_financeiras JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE operacoes ADD COLUMN IF NOT EXISTS identificacao_tipo_operacao INTEGER NULL;

CREATE INDEX IF NOT EXISTS idx_operacoes_id_venda_externo
  ON operacoes(id_venda_externo);

CREATE INDEX IF NOT EXISTS idx_operacoes_numero_operacao
  ON operacoes(numero_operacao);

CREATE INDEX IF NOT EXISTS idx_operacoes_data_emissao
  ON operacoes(data_emissao);

-- 3) Ajusta configs existentes para nova origem
UPDATE sistema_destino_config
SET tabela_origem = 'operacoes'
WHERE tabela_origem = 'pedidos';

-- 4) Atualiza procedure de normalização
...
BEGIN
  ...
  -- Persistência da operação (upsert por id_venda_externo)
  ...
  -- Outbox para destinos ativos de operacoes
  FOR v_destino IN
